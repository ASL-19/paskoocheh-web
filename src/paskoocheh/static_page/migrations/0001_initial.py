    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body', wagtail.fields.StreamField([('text', wagtail.blocks.RichTextBlock()), ('image', wagtail.images.blocks.ImageChooserBlock()), ('link', wagtail.blocks.URLBlock()), ('email', wagtail.blocks.EmailBlock()), ('collapsible', wagtail.blocks.StructBlock([('slug', wagtail.blocks.CharBlock(label='Slug')), ('heading', wagtail.blocks.CharBlock(form_classname='full title', label='Heading')), ('text', wagtail.blocks.RichTextBlock(label='Text'))], icon='collapse-up'))], use_json_field=True)),
                ('image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='static_page.captionedimage')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='renditions', to='static_page.captionedimage')),
            ],
            options={
